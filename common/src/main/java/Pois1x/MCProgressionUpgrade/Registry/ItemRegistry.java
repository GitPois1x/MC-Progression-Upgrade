...
public class ItemRegistry {
    ...
    public static final RegistrySupplier<Item> AMETHYST_SWORD = ITEMS.register("amethyst_sword", () -> new SwordItem(ToolMaterials.IRON, 4, -2.4f, new Item.Settings().group(CREATIVE_TAB)));
    public static final RegistrySupplier<Item> AMETHYST_PICKAXE = ITEMS.register("amethyst_pickaxe", () -> new PickaxeItem(ToolMaterials.IRON, 2, -2.4f, new Item.Settings().group(CREATIVE_TAB)));
    ...
    public static final RegistrySupplier<Item> COPPER_SWORD = ITEMS.register("copper_sword", () -> new SwordItem(ToolMaterials.IRON, 3, 1.2f, new Item.Settings().group(CREATIVE_TAB)));
    ...
    public static final RegistrySupplier<Item> EMERALD_SWORD = ITEMS.register("emerald_sword", () -> new SwordItem(ToolMaterials.IRON, 4, 1.1f, new Item.Settings().group(CREATIVE_TAB)));
    ...
    public static final RegistrySupplier<Item> JUNGLE_DAGGER = ITEMS.register("jungle_dagger", () -> new SwordItem(ToolMaterials.STONE, 0, -1.6f, new Item.Settings().group(CREATIVE_TAB)));
    public static final RegistrySupplier<Item> JUNGLE_HALBERD = ITEMS.register("jungle_halberd", () -> new SwordItem(ToolMaterials.STONE, 6, -2.8f, new Item.Settings().group(CREATIVE_TAB)));
    ...
    public static final RegistrySupplier<Item> JUNGLE_SPEAR = ITEMS.register("jungle_spear", () -> new SwordItem(ToolMaterials.STONE, 3, -2.4f, new Item.Settings().group(CREATIVE_TAB)));
    public static final RegistrySupplier<Item> JUNGLE_TOOTH = ITEMS.register("jungle_tooth", () -> new SwordItem(ToolMaterials.STONE, 8, -3.2f, new Item.Settings().group(CREATIVE_TAB)));
