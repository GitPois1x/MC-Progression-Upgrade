...
public class ItemRegistry {
    ...
    public static final RegistrySupplier<Item> CACTUS_HELMET = ITEMS.register("cactus_helmet", () -> new ArmorItem(MPUArmorMaterials.CACTUS, EquipmentSlot.HEAD, new Item.Settings().group(CREATIVE_TAB)));
    public static final RegistrySupplier<Item> CACTUS_CHESTPLATE = ITEMS.register("cactus_chestplate", () -> new ArmorItem(MPUArmorMaterials.CACTUS, EquipmentSlot.CHEST, new Item.Settings().group(CREATIVE_TAB)));
    public static final RegistrySupplier<Item> CACTUS_LEGGINGS = ITEMS.register("cactus_leggings", () -> new ArmorItem(MPUArmorMaterials.CACTUS, EquipmentSlot.LEGS, new Item.Settings().group(CREATIVE_TAB)));
    public static final RegistrySupplier<Item> CACTUS_BOOTS = ITEMS.register("cactus_boots", () -> new ArmorItem(MPUArmorMaterials.CACTUS, EquipmentSlot.FEET, new Item.Settings().group(CREATIVE_TAB)));
    ...
    public static final RegistrySupplier<Item> DIAMOND_SCYTHE = ITEMS.register("diamond_scythe", () -> new SwordItem(ToolMaterials.DIAMOND, 12, -3.2F, new Item.Settings().group(CREATIVE_TAB)));
    public static final RegistrySupplier<Item> DIAMOND_MACE = ITEMS.register("diamond_mace", () -> new SwordItem(ToolMaterials.DIAMOND, 8, -2.8F, new Item.Settings().group(CREATIVE_TAB)));
    public static final RegistrySupplier<Item> DIAMOND_CUTLASS = ITEMS.register("diamond_cutlass", () -> new SwordItem(ToolMaterials.DIAMOND, 0, -1.6F, new Item.Settings().group(CREATIVE_TAB)));
