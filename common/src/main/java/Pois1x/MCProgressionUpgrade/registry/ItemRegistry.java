...
public class ItemRegistry {
    ...
    public static final RegistrySupplier<Item> JUNGLE_PICKAXE = ITEMS.register("jungle_pickaxe", () -> new PickaxeItem(MPUToolMaterials.BONE, 0, -2.8F, new Item.Settings().group(CREATIVE_TAB)));
    ...
    public static final RegistrySupplier<Item> OVERGROWN_JUNGLE_TOOTH = ITEMS.register("overgrown_jungle_tooth", () -> new SwordItem(MPUToolMaterials.BONE, 8, -3.2F, new Item.Settings().group(CREATIVE_TAB)));
